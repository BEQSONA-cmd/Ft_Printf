...
int	main(void)
{
	...
	size_p += printf("|%-10c %-2c %-3c|\n", 0, 'X', 0);
	size_f += ft_printf("|%-10c %-2c %-3c|\n", 0, 'X', 0);

	size_p += printf("|%1c %5c %10c|\n", 0, 'X', 0);
	size_f += ft_printf("|%-1c %5c %10c|\n", 0, 'X', 0);
	size_p += printf("%s",
						ft_sprintf("|%%%c%%%s%%%d%%%i%%%u%%%x%%%X%%%%
										% % % c % % % s % % % d % % % i % % % u
											% % % x % % % X % % % % % % % c % %
											% s % % % d % % % i % % % u % % % x
											% % % X % % % % % c % %
	...
	size_p += printf("|%%%c%%%s%%%d%%%i%%%u%%%x%%%X%%%%
						...
						42,
						0);
	size_f += ft_printf("|%%%c%%%s%%%d%%%i%%%u%%%x%%%X%%%%
								% % % c % % % s % % % d % % % i % % % u % % % x
									% % % X % % % % % % % c % % % s % % % d % %
									% i % % % u % % % x % % % X % % % % % c % %
							|\n ", 'A', " 42 ", 42, 42, 42, 42, 42, 'B', "
	...
	size_p += printf("|%f|\t|%f|\t|%f|\t|%f|\t|%f|\t|%f|\t|%f|\t|%f|\n", 3.14,
			-3.14, 0.0, 1.0, 128.7584, -10000.253, 3.14, 3.14);
	...
	ft_printf("\n--------------------///////////////////////\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\--------------------------------\n\n");
	size_p
		+= printf("|%s|\t|%10s|\t|%-10s|\t|%10s|\t|%-10s|\t|%10.5s|\t|%-10.3s|\t|%-10.3s|\n",
			"string", "string", "string", "string", "string", "string",
			"string", "");
	size_f
		+= ft_printf("|%s|\t|%10s|\t|%-10s|\t|%10s|\t|%-10s|\t|%10.5s|\t|%-10.3s|\t|%-10.3s|\n",
			"string", "string", "string", "string", "string", "string",
			"string", "");
	...
	ft_printf("\n--------------------///////////////////////\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\--------------------------------\n\n");
	size_p
		+= printf("|%d|\t|%10d|\t|%-10d|\t|% 0d|\t|%-010d|\t|%+-10d|\t|%+-010.3d|\t|%+-010.15d|\n",
			42, 42, 42, 42, 42, 42, 42, 42);
	size_f
		+= ft_printf("|%d|\t|%10d|\t|%-10d|\t|% 0d|\t|%-010d|\t|%+-10d|\t|%+-010.3d|\t|%+-010.15d|\n",
			42, 42, 42, 42, 42, 42, 42, 42);
	ft_printf("\n--------------------///////////////////////\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\--------------------------------\n\n");
	size_p
		+= printf("|%i|\t|%10i|\t|%-10i|\t|%010i|\t|%-010i|\t|%+-10i|\t|%+-010.3i|\n",
			42, 42, 42, 42, 42, 42, 42);
	size_f
		+= ft_printf("|%i|\t|%10i|\t|%-10i|\t|%010i|\t|%-010i|\t|%+-10i|\t|%+-010.3i|\n",
			42, 42, 42, 42, 42, 42, 42);
	ft_printf("\n--------------------///////////////////////\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\--------------------------------\n\n");
	size_p
		+= printf("|%u|\t|%10u|\t|%-10u|\t|%010u|\t|%-010u|\t|%+-10u|\t|%+-010.3u|\n",
			42, 42, 42, 42, 42, 42, 42);
	size_f
		+= ft_printf("|%u|\t|%10u|\t|%-10u|\t|%010u|\t|%-010u|\t|%+-10u|\t|%+-010.3u|\n",
			42, 42, 42, 42, 42, 42, 42);
	size_p += printf("|%+-010.3f|\t|%+-010.15f|\n", 3.14, 3.14);
	size_f += ft_printf("|%+-010.3f|\t|%+-010.15f|\n", 3.14, 3.14);
	ft_printf("\n--------------------///////////////////////\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\--------------------------------\n\n");
	size_p
		+= printf("|%f|\t|%10f|\t|%-10f|\t|%010f|\t|%-010f|\t|%+-10f|\t|%+-010.3f|\t|%+-010.15f|\n",
			3.14, 3.14, 3.14, 3.14, 3.14, 3.14, 3.14, 3.14);
	size_f
		+= ft_printf("|%f|\t|%10f|\t|%-10f|\t|%010f|\t|%-010f|\t|%+-10f|\t|%+-010.3f|\t|%+-010.15f|\n",
			3.14, 3.14, 3.14, 3.14, 3.14, 3.14, 3.14, 3.14);
	ft_printf("\n--------------------///////////////////////\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\--------------------------------\n\n");
	...
	size_p
		+= printf("|%p|\t|%20p|\t|%-20p|\t|%020p|\t|%-020p|\t|%+020p|\t|%+020.3p|\n",
			(void *)0x7ffeec85e6b8, (void *)0x7ffeec85e6b8,
			(void *)0x7ffeec85e6b8, (void *)0x7ffeec85e6b8,
			(void *)0x7ffeec85e6b8, (void *)0x7ffeec85e6b8,
			(void *)0x7ffeec85e6b8);
	size_f
		+= ft_printf("|%p|\t|%20p|\t|%-20p|\t|%020p|\t|%-020p|\t|%+020p|\t|%+020.3p|\n",
			(void *)0x7ffeec85e6b8, (void *)0x7ffeec85e6b8,
			(void *)0x7ffeec85e6b8, (void *)0x7ffeec85e6b8,
			(void *)0x7ffeec85e6b8, (void *)0x7ffeec85e6b8,
			(void *)0x7ffeec85e6b8);
	ft_printf("\n--------------------///////////////////////\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\--------------------------------\n\n");
	size_p
		+= printf("|%x|\t|%10x|\t|%-10x|\t|%010x|\t|%-010x|\t|%+-10x|\t|%+-#010.3x|\t|%x|\n",
			255, 255, 255, 255, 255, 255, 255, 0);
	size_f
		+= ft_printf("|%x|\t|%10x|\t|%-10x|\t|%010x|\t|%-010x|\t|%+-10x|\t|%+-#010.3x|\t|%x|\n",
			255, 255, 255, 255, 255, 255, 255, 0);
	ft_printf("\n--------------------///////////////////////\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\--------------------------------\n\n");
	size_p
		+= printf("|%X|\t|%10X|\t|%-10X|\t|%010X|\t|%-010X|\t|%+-10X|\t|%+-#010.3X|\t|%+#020.15X|\n",
			255, 255, 255, 255, 255, 255, 255, 255);
	size_f
		+= ft_printf("|%X|\t|%10X|\t|%-10X|\t|%010X|\t|%-010X|\t|%+-10X|\t|%+-#010.3X|\t|%+#020.15X|\n",
			255, 255, 255, 255, 255, 255, 255, 255);
